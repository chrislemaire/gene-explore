...
import com.clemaire.gexplore.core.gfa.coordinates.crossing.algorithm.phase.{LayerBuilder, LayerMeasurer, MeasuredLayerSorter, QVertexResolver}
...
abstract class AlternatingLayer(nodes: mutable.ArrayStack[AlternatingNode])
  ...
  /**
    ...
    */
  def solveNewLayer(layer: mutable.ArrayStack[AlternatingNode]): Unit = {
